...
from tools.urpc.materialize_relia_model import CONFIG_FILENAMES, materialize
...
def job(args: argparse.Namespace, project: Path, identifier: str, seed: int) -> dict[str, Any]:
    ...
    model = materialize(identifier, project / "train" / "model_configs" / CONFIG_FILENAMES[identifier])
